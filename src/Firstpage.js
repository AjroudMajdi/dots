...
class Firstpage extends Component {
  ...
  makeWinMessage = (state) => {
    ...
    if (state.numRed > state.numBlue) {
      winMessage = `${this.props.location.state} wins! Select a board size to start a new game.`;
  ...
  render() {
    return (
      <div id="game" style={{ backgroundImage: `url(${background})` }}>
        <div id="header">
          <h1 id="welcome">Dots &amp; Boxes By Factory 619</h1>
          <p id="score">
            {" "}
            {this.props.location.state}:&nbsp;{this.state.numRed}{" "}
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Blue:&nbsp;
            {this.state.numBlue}{" "}
          </p>
